...
#define buzer A3  // pijn for active buzzer
int  hours, minutes, timp, seconds;
...
//  pinMode(13, OUTPUT);
 ...
 pinMode(SW0, INPUT);  // for this use a slide switch
  ...
  pinMode(buzer, OUTPUT);  // buzzer pin as output
  digitalWrite(buzer, LOW);  // buzzer is mtted
...
// hour indicator
  ...
  {
    digitalWrite(buzer, HIGH);  // sond on
  }
...
digitalWrite(buzer, LOW);  // sounf off
